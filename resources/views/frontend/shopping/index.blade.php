...
@section('content')
    <div class="container">
        ...
        <section class="py-5">
            <h2 class="h5 text-uppercase mb-4">Shopping cart list</h2>
            <div class="row">
                                ...
                                @foreach ($products as $row => $item)
                                    <tr>
                                        ...
                                        <td class="align-middle border-0">
                                            <p class="mb-0 small">{{ number_format($item->price, 0, ',', '.') }} VND</p>
                                        </td>
                                        <td class="align-middle border-0">
                    ...
                    <div class="bg-light px-4 py-3">
                        <div class="row align-items-center text-center">
                            <div class="col-md-6 mb-3 mb-md-0 text-md-left">
                                <a class="btn btn-link p-0 text-dark btn-sm" href="{{ route('get.home') }}"><i class="fas fa-long-arrow-alt-left mr-2"> </i>Continue shopping</a>
                            </div>
                            <div class="col-md-6 text-md-right">
                                <a class="btn btn-outline-dark btn-sm" href="{{ route('get.shopping.checkout') }}">Procceed to checkout<i class="fas fa-long-arrow-alt-right
                            ml-2"></i>
                                </a>
                            </div>
                        </div>
