                        ...
                        <div class="col-lg-10 col-xl-7 mx-auto">
                            ...
                            <form method="post" action="">
                                ...
                                <div class="form-group mb-3">
                                    <input id="inputEmail" type="email" name="email" placeholder="Email address" value="{{ old('email') }}"
                                           autocomplete="true" class="form-control rounded-pill border-0 shadow-sm px-4">
                                    @if($errors->first('email'))
                                        <small id="emailHelp" class="form-text text-danger">{{ $errors->first('email') }}</small>
                                    @endif
                                </div>
                                <div class="form-group mb-3">
                                    <input type="password" name="password" placeholder="Password" class="form-control rounded-pill border-0 shadow-sm px-4 text-primary">
